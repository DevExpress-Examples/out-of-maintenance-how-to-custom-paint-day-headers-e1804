...
Private Sub schedulerControl1_CustomDrawDayHeader(ByVal sender As Object,  _
		ByVal e As CustomDrawObjectEventArgs)
	Dim header As DayHeader = TryCast(e.ObjectInfo, DayHeader)
	' Draws the outer rectangle.
	e.Cache.FillRectangle(New LinearGradientBrush(e.Bounds, Color.LightBlue, _
	...
	e.Cache.FillRectangle(New LinearGradientBrush(e.Bounds, Color.Blue, _
		Color.LightSkyBlue, LinearGradientMode.Vertical), innerRect)
	' Draws the header's caption.
	e.Cache.DrawString(header.Caption, header.Appearance.HeaderCaption.Font, _
		New SolidBrush(Color.White), innerRect,  _
